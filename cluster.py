...
import torchvision
import numpy as np
from utils import visualization, make_dataset, confusion_matrix
from utils.yaml_config_hook import yaml_config_hook
from modules import resnet, network_jigsaw, transform
...
def make_ResNet(args, class_num):
    ...
    model = network_jigsaw.Network(res, args.feature_dim, class_num)
